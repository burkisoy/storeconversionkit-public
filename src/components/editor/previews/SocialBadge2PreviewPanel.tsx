...
const SocialBadge2PreviewPanel: React.FC<PreviewPanelProps> = ({ customValues }) => {
  ...
  useEffect(() => {
    const html = `
      ...
      ">
        ...
        ">
          <img 
            src="${customValues.icon_url || 'https://img.icons8.com/?size=100&id=32323&format=png&color=000000'}"
            alt="Social"
            style="
          ...
          <span style="color: ${customValues.text_color || '#000000'}">
            ${customValues.text || 'As seen on Instagram'}
          </span>
        </div>
      </div>
    `;
...
export default SocialBadge2PreviewPanel;